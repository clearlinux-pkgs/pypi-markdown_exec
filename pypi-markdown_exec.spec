...
Version  : 1.9.2
Release  : 14
URL      : https://files.pythonhosted.org/packages/5b/0a/259d1433de2ba9e586012f202fe9082ff3ad0b0220335734b90055c6cbb4/markdown_exec-1.9.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/5b/0a/259d1433de2ba9e586012f202fe9082ff3ad0b0220335734b90055c6cbb4/markdown_exec-1.9.2.tar.gz
...
%prep
%setup -q -n markdown_exec-1.9.2
cd %{_builddir}/markdown_exec-1.9.2
pushd ..
cp -a markdown_exec-1.9.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718920431
