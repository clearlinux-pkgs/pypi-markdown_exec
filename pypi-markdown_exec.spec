...
Version  : 1.8.0
Release  : 9
URL      : https://files.pythonhosted.org/packages/9a/9a/5857fa669849920c5114a76a77b71134675d0b6fdeb4920e63f4c89db9a9/markdown_exec-1.8.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/9a/9a/5857fa669849920c5114a76a77b71134675d0b6fdeb4920e63f4c89db9a9/markdown_exec-1.8.0.tar.gz
...
%description python
python components for the pypi-markdown_exec package.


%package python3
Summary: python3 components for the pypi-markdown_exec package.
Group: Default
Requires: python3-core
Provides: pypi(markdown_exec)
Requires: pypi(pymdown_extensions)

%description python3
python3 components for the pypi-markdown_exec package.


%prep
%setup -q -n markdown_exec-1.8.0
cd %{_builddir}/markdown_exec-1.8.0
pushd ..
cp -a markdown_exec-1.8.0 buildavx2
popd
pushd ..
cp -a markdown_exec-1.8.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707126308
